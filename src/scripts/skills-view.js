...
const SkillsView = React.createClass({
  ...
  //
  //   } else if(hexagon.target.localName === "h2"){
  //
  //     let daDiv = hexagon.path[1]
  //     let daClass = daDiv.className
  //
  //     daDiv.className = daClass + showClass
  //
  //   } else if(hexagon.target.localName === "p"){
  //     let daDiv = hexagon.path[2]
  //     let daClass = daDiv.className
  //
  //     daDiv.className = daClass + showClass
  //
  //   } else if(hexagon.target.className === "hexagon"){
  //
  //
  //   }
  // },
